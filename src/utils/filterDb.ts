...
export const applyFilters = (db: Vehicle[], activeFilters: AppFilters): Vehicle[] => {
  const { filterPrem, filterGift, filterBr, gameMode, filterNation, filterRank } = activeFilters
